"""
Índice de frames para escena 1.
...
def _load_part_lazy(part_idx):
    ...
    module_name = f'scene_1_frames_part{part_idx}'
    create_func_name = f'create_scene1_frames_part{part_idx}'
    ...
    try:
        ...
        import importlib
        module = importlib.import_module(f'.{module_name}', package='scenes.scene_1')
        return getattr(module, create_func_name)
...
def create_scene1_frames():
    """Retorna un LazyFrameLoader para la escena 1 (sin cargar módulos)."""
    return LazyFrameLoader(15, _LOADERS_INFO)
