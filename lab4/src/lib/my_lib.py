"""
Módulo de librería auxiliar.
"""
import utils.scenes as s

def scene_name(scene) -> str:
    return scene.name

def scene1_frames(self, scene: s.scene1) -> list:
...
def scene2_frames(self, scene: s.scene2) -> list:
...
def scene3_frames(self, scene: s.scene3) -> list:
...
def scene4_frames(self, scene: s.scene4) -> list:
